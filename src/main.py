...
if __name__ == "__main__":
    ...
    output_df = sample_query(spark)

    gcs_path = "gs://cf-wiki-data/wikipedia_output/"

    output_df.write.format("parquet").mode("overwrite").partitionBy("month").save(
        gcs_path
    )
